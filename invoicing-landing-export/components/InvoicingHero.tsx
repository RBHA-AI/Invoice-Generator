...
const APP_URL = 'https://invoice.invoicecreation.store'
          ...
          <div>
            ...
            >
              <a
                ...
                className="inv-btn-primary inline-flex items-center justify-center gap-2 rounded-xl px-7 py-3.5 text-base font-semibold"
              >
                Launch App
